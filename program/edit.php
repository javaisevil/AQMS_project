...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $can_edit) {
    ...
    if (isset($_POST['next'])) { header('Location: edit.php?id=' . $program_id . '&step=' . min($step + 1, 8)); exit(); }
...
$labels = [1=>'A/B. Identification, Mission, Goals',2=>'A/D/E/F/G. TP-151 Details',3=>'C. Curriculum Structure',4=>'C. Program Courses',5=>'C. PLO Strategies & Assessment',6=>'E. Staff',7=>'G. Evaluation Matrix',8=>'H. Approval & Review'];
...
<?php if($errors): ?><div class="alert alert-warning"><strong>Missing before complete TP-151:</strong><ul><?php foreach($errors as $e): ?><li><?php echo h($e); ?></li><?php endforeach; ?></ul></div><?php else: ?><div class="alert alert-success">Program specification is complete.</div><?php endif; ?>
